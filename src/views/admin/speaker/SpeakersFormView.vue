...
async function handleSave() {
  ...
  try {
    ...
    const payloadBody = {
      ...speakerForm.value,
      id: isEditMode.value ? speakerId : undefined,
...
<template>
  <div class="px-6 py-4">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
      <form @submit.prevent="handleSave" id="speaker-form" class="space-y-4">
        <div>
        ...
        <div>
          ...
          <div class="relative mt-1">
            ...
            <input
              v-model="speakerForm.phone_number"
              type="number"
              min="0"
